 ...
 <?php 
	...
	if( isset($_GET["q"] ) || isset($_POST["Sumbit_ans"]) )
	{
		$q = $_GET["q"];
...
<h3 align="center" > <?php echo $paper_name; ?></h3>
<br/>
<form method="POST">
<br/>
	<?php if(isset($_GET['q'] ) )	{?>
	<b><?php echo $_GET['q']; $q_num =  $_GET['q'];}?></b><br/>
	<textarea name="question" placeholder="Type Question No.<?php if(isset($_GET['q'] ) )	{echo $_GET['q']; }?>" rows="10" style="font-size:16px" value="<?php if(isset($question)) {echo $question;}?>" required>
...
<?php 
if( isset($_POST["next"]) || isset($_POST["Sumbit_ans"]) ){
...
?>
<br/>
<input type="submit" id="submit" name="Sumbit_ans" value="Save Paper" />
	<p><br/><br/><br/><br/></p>
</div>
</body>
<footer >
